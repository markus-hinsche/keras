...
class _BaseOptimizer(tf.Module):
  ...
  def add_variable_from_reference(self,
    ...
    Args:
      ...
      custom_shape: List or Tuple, defaults to None. The shape of the optimizer
    ...
    if initial_value is None:
      if custom_shape is None:
        ...
        initial_value = tf.zeros(custom_shape, dtype=model_variable.dtype)
    return tf.Variable(
